...
<p align="center">
  <a href="https://labex.io/pt/courses/client-side-attacks-authentication">
    <img src="https://course-cover.labex.io/client-side-attacks-authentication.png?lang=pt" alt="Ataques do Lado do Cliente e Autenticação">
  </a>
</p>
...
[Iniciar curso no LabEx](https://labex.io/pt/courses/client-side-attacks-authentication)

## Exercícios

|   Índice | Nome                                 | Dificuldade   | Prática                                                                                                                                                      |
|----------|--------------------------------------|---------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------|
|        1 | Cross-Site Scripting (XSS) Refletido | Iniciante     | <a target='_blank' href='https://labex.io/pt/labs/linux-reflected-cross-site-scripting-xss-656160?course=client-side-attacks-authentication'>Iniciar Lab</a> |
|        2 | Stored Cross-Site Scripting          | Iniciante     | <a target='_blank' href='https://labex.io/pt/labs/linux-stored-cross-site-scripting-656161?course=client-side-attacks-authentication'>Iniciar Lab</a>        |
|        3 | Força Bruta em Autenticação Web      | Iniciante     | <a target='_blank' href='https://labex.io/pt/labs/linux-web-authentication-brute-force-656162?course=client-side-attacks-authentication'>Iniciar Lab</a>     |
|        4 | Controle de Acesso Quebrado (IDOR)   | Iniciante     | <a target='_blank' href='https://labex.io/pt/labs/linux-broken-access-control-idor-656159?course=client-side-attacks-authentication'>Iniciar Lab</a>         |
|        5 | Desafio de Invasão de Aplicação Web  | Intermediário | <a target='_blank' href='https://labex.io/pt/labs/linux-web-app-takeover-challenge-656158?course=client-side-attacks-authentication'>Iniciar Desafio</a>     |
